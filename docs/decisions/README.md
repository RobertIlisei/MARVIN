...
| [0078](./0078-pty-terminal-in-process.md) | The terminal is a real PTY owned by the app — persistent login shell, Ctrl-C, SwiftTerm as renderer only; `/api/terminal/run` deleted | Accepted | 2026-08-29 |
